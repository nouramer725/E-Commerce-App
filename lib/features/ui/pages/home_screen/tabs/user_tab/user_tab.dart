...
class _UserTabState extends State<UserTab> {
  TextEditingController fullNameController = TextEditingController(text: "nour mohamed");
  TextEditingController emailController = TextEditingController(text: "nouramer355@@gmail.com");
  TextEditingController passwordController = TextEditingController(text: "**********");
  TextEditingController mobileController = TextEditingController(text: "01274554479");
